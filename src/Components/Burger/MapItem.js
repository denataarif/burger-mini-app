    ...
    return(
        <div className={style.map_item}>
            ...
            <div className={style.map_controller}>
                {/* Icon digunakan sebagai button untuk menghaous ingredient */}
                <BiMinusCircle onclick={props.removeHandler} className={style.remove_button} />
                {/* Icon digunakan sebagai button untuk menaikkan ingredient, ditampilkan bila prop.firstItem = false */}
